...
- (void)setupPlayer {
    //初始化播放器并设置播放地址
    NSString *tempUrl = @"http://7xqhmn.media1.z0.glb.clouddn.com/femorning-20161106.mp4";
    self.player = [[KSYMoviePlayerController alloc] initWithContentURL: [NSURL URLWithString:tempUrl] fileList:nil sharegroup:nil];
