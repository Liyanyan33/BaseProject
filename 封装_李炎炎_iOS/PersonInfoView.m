...
- (UILabel*)nameLabel{
    if (!_nameLabel) {
        _nameLabel = [UILabel labelWithText:@"" font:ScreenFitFont(16) textColor:[UIColor orangeColor]];
    }
    return _nameLabel;
}
...
- (UILabel*)sourceLabel{
    if (!_sourceLabel) {
        _sourceLabel = [UILabel labelWithText:@"" font:ScreenFitFont(12) textColor:[UIColor grayColor]];
